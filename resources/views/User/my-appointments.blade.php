...
<body class="font-sans antialiased">
    ...
    <main>
        <div class='space-y-4 flex flex-col '>
            ...
            {{-- {{-- {/* end  sec nav */} --}}
            {{-- display appointments for users --}}
            <div class="h-screen">
                @include('user.notifications')
                <div class="relative overflow-x-auto rounded-lg border border-green-300 md:mx-24 mx-4">
                                    ...
                                    <td scope="row"
                                        ...
                                        <div class="flex space-x-2">
                                            <form
                                                ...
                                                method="POST"
                                                action="{{ url('cancel-appointment', $appointment->id) }}"
            ...
            <footer class="p-5 md:px-24  bg-green-900">
                <div class="grid grid-cols-2 sm:grid-cols-4">
                    ...
                    <div class="">
                        ...
                        <h1 class=" text-white">Join as appointments</h1>
                    </div>
                    <div class="">
                ...
                <h2 class="text-white text-center my-3 md:text-left">Copyright &copy; 2024 <a
                        href="www.obertmanyasa.web.app">codeStar</a>. All rights reserved.</h2>
            </footer>
            {{-- {/* end footer */} --}}
        </div>
