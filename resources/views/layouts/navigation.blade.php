            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->is_admin)
                        ...
                        <x-nav-link :href="route('admin.news-updates.index')" :active="request()->routeIs('admin.news-updates.index')">
                            {{ __('News') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="flex p-3">
                ...
                <x-nav-link :href="route('admin.index')" :active="request()->routeIs('adminx.index')">
                    {{ __('Dashboard') }}
                </x-nav-link>
